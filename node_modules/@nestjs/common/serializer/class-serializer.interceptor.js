...
let ClassSerializerInterceptor = class ClassSerializerInterceptor {
    constructor(reflector, defaultOptions = {}) {
        ...
        classTransformer = (0, load_package_util_1.loadPackage)('class-transformer', 'ClassSerializerInterceptor', () => require('class-transformer'));
...
ClassSerializerInterceptor = (0, tslib_1.__decorate)([
    (0, core_1.Injectable)(),
    (0, tslib_1.__param)(0, (0, core_1.Inject)(REFLECTOR)),
